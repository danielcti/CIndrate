...
// 
//float calibration_factor = 4900;   // fator de calibração para teste inicial
//float avg = 0.0;
//int counter = 0;
// 
//void setup()
...
//  
//  avg += balanca.get_units(5);
//  counter++;
//
//  if(counter > 10) {
//    Serial.print("Peso: ");   // imprime no monitor serial
//    Serial.print(avg/counter, 3);   // imprime peso da balança com 3 casas decimais
//    Serial.print(" kg");
